...
import { ArrowRight, Box, Leaf, Sprout, Target } from 'lucide-react';
...
const solutions = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1530836369250-ef71a3a5e48c?auto=format&fit=crop&w=800&q=80',
    color: '#16a34a'
  },
  {
    id: 'yellior',
...
const SolutionsPage = () => {
  ...
  const filteredSolutions = filter === 'Tous' 
    ? solutions 
        ...
        <div className="container">
          ...
          >
            ...
            <p className="lead" style={{ marginTop: '1.5rem', color: 'var(--gray-600)' }}>
              Découvrez nos missions concrètes menées depuis 2024 au service du développement durable africain.
            </p>
          </motion.div>
                ...
                >
                  ...
                  <div style={{ padding: '1.5rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                      <div style={{ width: '40px', height: '40px', borderRadius: '8px', backgroundColor: `${sol.color}20`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: sol.color }}>
                        <Icon size={20} />
                      </div>
                    ...
                    <p style={{ color: 'var(--gray-600)', lineHeight: '1.6', marginBottom: '1.5rem', flex: 1 }}>
                      {sol.desc}
                    </p>
